        ...
        parameters {
            ...
            stages {
                stage('Trigger Second Jenkinsfile') {
                    steps {
                        build job: "/jerrynab/multibranch/blob/main/child_project/", wait: true, parameters: [[$class: 'StringParameterValue', name: 'VM_Name', value: "${VM_Name}", description: 'develop-stack']];
