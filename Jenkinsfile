        ...
        parameters {
            ...
            stages {
                stage('Trigger Second Jenkinsfile') {
                    steps {
                        build job: "https://github.com/jerrynab/child_project/master", wait: true, parameters: [[$class: 'StringParameterValue', name: 'VM_Name', value: "${VM_Name}", description: 'develop-stack']];
